...
function getSlice(slice_type, slice_idx) {
    $.ajax({
        url: base_url + "/image?" + "slice_type=" + slice_type + "&slice_idx=" + slice_idx,
        method: "GET",
        success: function (data) {
            switch (slice_type) {
